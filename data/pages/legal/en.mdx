...
owner:
  {
    isEntity: true,
    name: 'Jonathan Corral',
    legalStatus: 'EI',
    shareCapital: '',
    registration: { siret: '88427302000013', rcs: '', vat: 'FR2288427302000013', artisan: '' },
    address: '7 route de Gratentour, 31140 Pechbonnieu, France',
    phone: '+33 6 95 47 14 05',
    mail: '',
    publicationDirector: 'Jonathan Corral',
  }
host:
  {
    name: 'Vercel Inc.',
